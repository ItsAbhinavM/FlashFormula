...
class _HomePageState extends State<HomePage> {
  final List<FlashCard> _flashCard = [
    FlashCard(
      ...
      answer: Math.tex('x^2 + y^2 = z^2'),
    ),
    FlashCard(
        question: Math.tex("What is the formula of Ohmslaw ?"),
        answer: Math.tex('\frac a b')),
    FlashCard(
        question: Math.tex("What is the formula of charge ?"),
        answer: Math.tex('\frac a b'))
  ];
                          ...
                          child: Card(
                              ...
                              child: FlipCard(
                                  front: Padding(
                                      ...
                                      child: FlashCardView(
                                          text: _flashCard[_currentIndex]
                                              .question)),
                                  back: FlashCardView(
                                      text:
                                          _flashCard[_currentIndex].answer)))),
                    )),
                Row(
